const body = document.querySelector("body"), btnToggle = document.querySelector(".btn-icon-container"), modeIcon = document.querySelector(".mode-icon");
...
//# sourceMappingURL=index.64749962.js.map
